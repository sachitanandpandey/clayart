...
STATIC_ROOT = os.path.join(os.path.dirname(os.path.dirname(__file__)), "static_in_env", "static_root")
...
MEDIA_ROOT = os.path.join(os.path.dirname(os.path.dirname(__file__)), "static_in_env", "media_root")
